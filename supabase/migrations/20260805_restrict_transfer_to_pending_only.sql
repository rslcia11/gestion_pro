-- Corrección de negocio: una vez entregado ('approved') un premio, ya NO se
-- puede transferir. Solo se puede transferir mientras sigue en 'pending'
-- (antes de solicitarlo). La versión anterior de esta función permitía
-- transferir también en 'approved'; se restringe a pedido del dueño del
-- producto.
BEGIN;
